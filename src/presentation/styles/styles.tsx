...
function createThemedStyles(themeMode: AppThemeMode) {
  ...
  return StyleSheet.create({
    ...
    copyableUrl: { color: palette.accent, fontSize: 11, marginTop: 5 },
    ...
    playerBody: { flexGrow: 1, alignItems: 'center', justifyContent: 'center', paddingBottom: 24 },
    ...
    settingsToggleRow: { minHeight: 64, borderRadius: 8, borderWidth: 1, borderColor: palette.border, backgroundColor: palette.surface, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, paddingHorizontal: 12, paddingVertical: 10, marginBottom: 8 },
    settingsToggleActive: { backgroundColor: palette.surfaceRaised, borderColor: palette.accent },
    settingsToggleDisabled: { opacity: 0.58 },
